	...
	<div class="ads-grid">
		<div class="container">
			...
			<div class="side-bar col-md-3">
				...
				<?php
					$sql = "SELECT * FROM tbl_product "; // sql command
					...
					<div class="special-sec1">
						...
						<div class="col-xs-8 img-deal1">
							...
							<a href=""><?php echo $row['productPrice']?></a>
						</div>
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single2.php"><?php echo $row['productName']?></a>
									</h4>
									<div class="info-product-price">
										<span class="item_price"><?php echo $row['productPrice']?></span>
