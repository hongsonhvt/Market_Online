...
?>
	...
	<div class="product-feedback">
		<h2>Feedback</h2>
		<form action="#" id="show_form">
			<div class="input-feedback">
				<div class="input-space"></div>
				<input type="text" class="input-user" placeholder="Input name">
				<input type="email" class="input-user" placeholder="Input Email">
				<textarea name="" id="" cols="30" rows="10" class="col-full input-description" placeholder="Input your feedback"></textarea>
		...
		<div class="user-feedback">
			...
			<p class="cUser-feedback">
				I bought this product and i loved it
			</p>
		</div>
		<div class="user-feedback">
			<b>
