        ...
        <div class="col-md-10">
            <div class="row-voucher  p-2 bg-white border-voucher rounded">
                ...
                <div class="col-md-6 mt-1">
                    ...
                    <p class="text-justify text-truncate para mb-0"><?php echo $row['hisproductStatus']?> <br><br></p>
                    <div class="mt-1 mb-1 spec-1"><span>Quantity : <?php echo $row['hisproductQuantity']?></span></div>
                    <p class="text-justify text-truncate para mb-0">Delivered : <?php echo $row['hisproductDate']?><br><br></p>
                </div>
